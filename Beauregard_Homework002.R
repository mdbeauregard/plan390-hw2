...
summarize(city_averages, CITY, SCORE)
...
summarize(inspector_averages, INSPECTOR, SCORE)
...
summarize(facility_averages, FACILITYTYPE, SCORE)
...
summarize(city_r_averages, CITY, SCORE)
...
summarize(inspector_r_averages, INSPECTOR, SCORE)
